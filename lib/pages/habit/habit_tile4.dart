    ...
    return SingleChildScrollView(
      child: IndexedStack(
          ...
          children: <Widget>[
            ...
            Container(
              //index 1: edit habit name & milestones
                            ...
                            style: ButtonStyle(
                                backgroundColor:
                                    const MaterialStatePropertyAll<Color>(
                                        Color.fromARGB(255, 255, 174, 60)),
                                minimumSize: MaterialStateProperty.all(
                                    const Size(100, 30))), //button style
                            onPressed: () {
            ...
            Center(
              //this is container to edit milestone totals. Index = 2
              child: Container(
                margin: const EdgeInsets.all(10),
                width: 400,
                height: 200,
            ...
            Center(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(
                  children: const [
                    Padding(
                      padding: EdgeInsets.fromLTRB(75.0, 0, 50.0, 0),
                      child: Text(
                        "1st",
                        style: TextStyle(color: Colors.white54),
                      ),
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(75, 0, 50, 8),
                      child: SizedBox(
                        width: 40,
                        height: 40,
                        child: TextField(
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(50, 0, 75, 8.0),
                      child: SizedBox(
                        width: 40,
                        height: 40,
                        child: TextField(
            ...
            Center(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(
                  children: const [
                    Padding(
                      padding: EdgeInsets.fromLTRB(50.0, 8.0, 25.0, 0),
                      child: Text(
                        "1st",
                        style: TextStyle(color: Colors.white54),
                      ),
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(50.0, 0, 25.0, 8.0),
                      child: SizedBox(
                        width: 40,
                        height: 40,
                        child: TextField(
                    ...
                    Padding(
                      padding: const EdgeInsets.fromLTRB(25.0, 8.0, 50.0, 8.0),
                      child: SizedBox(
                        width: 40,
                        height: 40,
                        child: TextField(
